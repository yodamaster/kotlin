...
public class KotlinTypeMapper {
    ...
    private FunctionDescriptor unwrapFakeOverrideWithRestriction(@NotNull FunctionDescriptor descriptor, boolean isSuperCall) {
    ...
    public CallableMethod mapToCallableMethod(@NotNull FunctionDescriptor descriptor, boolean superCall) {
        ...
        FunctionDescriptor functionDescriptor = unwrapFakeOverrideWithRestriction(descriptor.getOriginal(), superCall);
