...
// collection of additional, optional annotations
object Serial {
...
open class ElementValueTransformer {
    ...
    private inner class Input(private val list: List<Any?>) : KInput() {
        ...
        override fun readElementValue(desc: KSerialClassDesc, index: Int): Any { cur(desc,index); return readValue() }
        override fun readNullableElementValue(desc: KSerialClassDesc, index: Int): Any? { cur(desc,index); return readNullableValue() }
